...
$(document).ready(function() {
  ...
  $(".loadradar").click(function() {
    ...
    if (location.protocol === 'https:') {
      if (data.cache == "20") {
        img.attr("src", "https://cdn.pakin.me/storage/radarimg/gqk2r6/" + time20 + "/" + data.img + "?rainradar&errorredirect=ssl:cdn.jsdelivr.net/gh/pknme/rainradar@7.0.0/img/error-960.png");
      } else if (data.imganiold === "yes") {
        img.attr("src", "https://cdn.pakin.me/storage/images/blank.gif");
      } else {
        img.attr("src", "https://cdn.pakin.me/storage/radarimg/gqk2r6/" + time5 + "/" + data.img + "?rainradar&errorredirect=ssl:cdn.jsdelivr.net/gh/pknme/rainradar@7.0.0/img/error-960.png");
        if (data.imgani === "yes") {
