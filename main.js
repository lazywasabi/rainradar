...
if (hash == "") {
  ...
  stxt.load("../content/home.html?v=8.3.1");
...
$(document).ready(function() {
  ...
  $(".loadradar").click(function() {
    ...
    if (location.protocol === 'https:') {
      if (data.cache == "20") {
        img.attr("src", "https://images-api-cdn.pakin.me/rainradar/i/" + time20 + "/" + data.img + "?rainradar=8.3.1");
        //img.attr("src", "https://images.weserv.nl?url=" + data.img + "?rainradar=8.3.1" + time20);
      } else if (data.imganiold === "yes") {
        img.attr("src", "https://cdn.pakin.me/storage/images/blank.gif");
      } else {
        img.attr("src", "https://images-api-cdn.pakin.me/rainradar/i/" + time5 + "/" + data.img + "?rainradar=8.3.1");
        //img.attr("src", "https://images.weserv.nl?url=" + data.img + "?rainradar=8.3.1" + time5);
        if (data.imgani === "yes") {
